...
okay = int(input("Enter Time in Seconds: "))

curTime = time.ctime(time.time())
fileName = curTime[4:13] + "." + curTime[14:16]
f = open("{var}.csv".format(var = fileName), "x")
with open("{var}.csv".format(var = fileName), 'r+') as f:
